...
# =====================================================
# CENTROID CLUSTERER (ALTITUDE-AWARE)
# =====================================================
class CentroidClusterer:
    ...
    def add(self, lat, lon, altitude):
        radius = max(self.base_radius, altitude * 0.8)
...
def main():
    ...
    while True:
        ...
        for b in res.boxes:
            ...
            ray = pixel_to_ray(u, v, img.shape[1], img.shape[0],
                               cfg.camera.hfov_deg, cfg.camera.vfov_deg)
            rw = rotate_ray(ray, drone.heading_deg, drone.pitch,
                            drone.roll, cfg.pitch_offset)
            ...
            clat, clon, is_new = clusterer.add(lat, lon, drone.alt_agl)
